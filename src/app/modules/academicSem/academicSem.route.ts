...
import { createAcademicSemesterZod, updateAcademicSemesterZod } from './academicsemValidate.jod';
    ...
    router.patch("/AcademicSemester/:semesterId",validateRequest(updateAcademicSemesterZod),updateAcademicSemController)
